...
General or lower-risk situation

🟡

Medium

Situation may require closer observation

🟠

High

Potentially concerning situation

🔴

Urgent

Situation may require prompt professional attention
...
Animio brings together mobile, backend, cloud, and AI technologies in a single full-stack project.

Mobile       → React Native + TypeScript
Backend      → Node.js + Express.js
Cloud        → Firebase
AI           → OpenAI API
Assessment   → Custom Rule-Based Risk Scoring
...
Built with care using React Native, TypeScript, Firebase, Node.js & Express.js
